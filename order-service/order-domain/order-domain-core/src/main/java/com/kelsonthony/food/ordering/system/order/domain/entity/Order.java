...
import com.kelsonthony.food.ordering.system.order.domain.valueobject.OrderItemId;
...
public class Order extends AggregateRoot<OrderId> {
    ...
    public void pay() {
        if (orderStatus != OrderStatus.PENDING) {
            throw new OrderDomainException("Order is not in correct stats for pay operation");
        }
